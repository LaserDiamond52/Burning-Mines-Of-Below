...
public class BMOBSkullBlockRenderer {
    ...
    /**
     * Adds the {@link SkullBlock.Type} to all {@link net.minecraft.client.renderer.entity.player.PlayerRenderer}s
     * @param type The {@link SkullBlock.Type} to add
     * @param modelLayerLocation The {@link ModelLayerLocation} of the {@link SkullBlock}
     * @param playerRendererMap The {@link net.minecraft.client.renderer.entity.player.PlayerRenderer} to add the {@link SkullBlock} to
     */
